...
export default function ComparisonChart({ data, loading }: ComparisonChartProps) {
  ...
  if (!data || data.length === 0) {
    return (
      <div className="card">
        <h3 className="text-lg font-bold text-gray-800 mb-4">孩子表现对比</h3>
  ...
  return (
    <div className="card">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-xs text-gray-500">{data.length}个孩子</span>
      </div>
      ...
      <div className="mt-6 pt-4 border-t border-gray-100">
        <h4 className="text-sm font-semibold text-gray-700 mb-3">综合排名</h4>
        <div className="space-y-2">
          {[...normalizedData]
            .sort(
              (a, b) =>
            ...
            .map((child, index) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <span className="text-xs text-gray-500 ml-1">任务</span>
                </div>
              </div>
            ))}
        </div>
